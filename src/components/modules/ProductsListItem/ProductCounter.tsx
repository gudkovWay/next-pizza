import { updateCartItemCount } from '@/features/context/cart'
import { updateCartItemCountInLS } from '@/shared/lib/utils/cart'
import { isUserAuth } from '@/shared/lib/utils/common'
import { IProductCounterProps } from '@/shared/types/goods'
