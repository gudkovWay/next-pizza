      ...
      <div className='container'>
        ...
        <div className='wpb_wrapper'>
          ...
          <p>
            ...
            индекса удовлетворе предоставляемых Операторами товаров и услуг,
            проводимых Операторами самостоятельно, или с привлечением третьих
            лиц, для осуществления рассылок.
          </p>
          <p>&nbsp;</p>
          <p>
          ...
          <p>
            ...
            доступа к персональным данным, а также конт применяемых мер.
          </p>
          <p>
